...
// Not the same as the original Ken Perlin's permutation table, to avoid the copyright
var perm = [257]int{
	180, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69, 142,
